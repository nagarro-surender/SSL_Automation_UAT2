...
public class SS_MyAccount_Verify_Order_Details {
	...
	public void main() throws Exception {
		try {
			...
			Utils.waitForElement(MyAccount_Page.OrderHistory.OrderHistoryTab());
			Utils.waitForElement(MyAccount_Page.OrderHistory.ReturnExchangeOrdersTab());
