...
/**
 * 
 * <h2 style="text-align:center;">SS_Forgot_Password_CorrectFormNavigation</h2>
...
public class SS_Forgot_Password_CorrectFormNavigation {
	...
	public void main() throws Exception {
		try {
			...
			Log.info("Correct form is opened after clicking forgot password link");
			ExcelUtils.setCellData("Pass", iTestCaseRow, Constant.result);
			Utils.captureScreenshot(sTestCaseName, "Pass", "Passed");

		} catch (Exception e) {
			Log.error("Issue in reaching correct forgot password form");
