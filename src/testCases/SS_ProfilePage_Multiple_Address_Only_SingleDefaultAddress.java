...
/**
 * 
 * <h2 style="text-align:center;">SS_ProfilePage_Multiple_Address_Only_SingleDefaultAddress</h2>
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies only single default address on addition of multiple delivery addresses</p>
	...
	public void main() throws Exception {
		try {
			...
			if (MyAccount_Page.ProfilePage.DefaultShippingAddresstext().size() == 1) {
				...
				Log.info("Only one address is marked as default shipping address");
				Utils.captureScreenshot(sTestCaseName, "Pass", "Passed");

			} else {

				throw new Exception(
						"Either Multiple addressess are set or no address is set as default shipping address");
			}
