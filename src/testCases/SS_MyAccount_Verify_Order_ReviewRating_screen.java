...
public class SS_MyAccount_Verify_Order_ReviewRating_screen {
	...
	public void main() throws Exception {
		try {
			...
			MyAccount_Page.OrderHistory.WriteAProductReviewButton().click();
			MyAccount_Action.Verify_OrderDetailPage_ReviewRatingWindow_Functionality(iTestCaseRow);
