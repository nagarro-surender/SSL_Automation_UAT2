...
public class SS_CheckOut_MiniCart_AlreadyLoginUser_NewAddress_Coupanapply_CheckMiniCartPrice {
	...
	public void main() throws Exception {
		try {
			...
			Thread.sleep(5000);
			Cart_Action.Verify_Private_Cart_Page_RemoveCoupanOnCartPage(iTestCaseRow);
