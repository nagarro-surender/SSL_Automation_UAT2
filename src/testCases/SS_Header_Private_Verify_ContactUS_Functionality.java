...
public class SS_Header_Private_Verify_ContactUS_Functionality {
	...
	public void main() throws Exception {
		try {
			...
			HomePage_Action.Header_Private_Verify_ContactUS_Functionality(iTestCaseRow);
			Log.error("Verification for ContactUS icon functionality in Header successfull");
			...
			Log.error("Verification for ContactUS icon functionality in Header failed");
