...
public class SS_PLP_Verify_L2L3_Double_Functionality {
	...
	public void main() throws Exception {
		try {
			...
			PLP_Action.PLP_Verify_ShowMoreShowLess_Functionlaity(iTestCaseRow);
			ExcelUtils.setCellData("Pass", iTestCaseRow, Constant.result);
			Log.info("Verification for ShowMoreShowLess LInk functionality on PLP page successfull");

		} catch (Exception e) {
			Log.info("Verification for ShowMoreShowLess LInk functionality on PLP page failed");
