...
public class SS_CheckOut_NewAddress_Clinique {
	...
	public void main() throws Exception {
		try {
			...
			HomePage_Action.selectProductCategoryfromMenuClinique(iTestCaseRow);
			Log.info("Product category selected successfully");
			ProductListing_Page.cliniqueproduct().click();
