...
public class SS_CheckOut_LoginAtCheckout_CheckAddress_AllBlank {
	...
	public void main() throws Exception {
		try {
			...
			CheckOut_Action.ProceedwithNewAddressAllFieldEmpty(iTestCaseRow);
			System.out.println(Cart_Page.FirstNameFieldAlert().getAttribute("title"));
